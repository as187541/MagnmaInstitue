// ============================================================
// Supabase Seed Script - Populates colleges and courses data
...
// --- Colleges Data (from existing college-data.js) ---
const colleges = [
  {
    id: "iq-city",
    name: "IQ City Medical College",
    logo_image: "assets/images/colleges/iqcity/iq.png",
    ...
    approved_by: ["NMC (National Medical Commission)", "WHO"],
    affiliated_to: "West Bengal University of Health Sciences (WBUHS)",
    admission_process: [
    ...
    images: [
      "assets/images/colleges/iqcity/iq2.jpg",
      "assets/images/colleges/iqcity/iq3.jpg",
      "assets/images/colleges/iqcity/iq4.jpg",
      "assets/images/colleges/iqcity/iq5.jpg",
    ],
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/srims/srims-logo.png",
    ...
    approved_by: ["NMC (National Medical Commission)"],
    affiliated_to: "The West Bengal University of Health Sciences (WBUHS)",
    admission_process: [
    ...
    images: [
      "assets/images/colleges/srims/srims-campus-1.jpg",
      "assets/images/colleges/srims/srims-hospital-wing.jpg",
      "assets/images/colleges/srims/srims-classroom.jpg",
      "assets/images/colleges/srims/srims-library.jpg",
    ],
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/jims/jims-logo.png",
    ...
    images: [
      "assets/images/colleges/jims/jims-campus.jpg",
      "assets/images/colleges/jims/jims-hospital.jpg",
      "assets/images/colleges/jims/jims-classroom.jpg",
      "assets/images/colleges/jims/jims-lab.jpg",
    ],
    courses: ["MBBS", "MD", "MS"],
  },
  {
    ...
    logo_image: "assets/images/colleges/kpcmc/kpcmc-logo.png",
    ...
    approved_by: ["NMC (National Medical Commission)"],
    affiliated_to: "West Bengal University of Health Sciences",
    admission_process: [
    ...
    images: [
      "assets/images/colleges/kpcmc/kpcmc-campus.jpg",
      "assets/images/colleges/kpcmc/kpcmc-hospital.jpg",
      "assets/images/colleges/kpcmc/kpcmc-library.jpg",
      "assets/images/colleges/kpcmc/kpcmc-lab.jpg",
    ],
    courses: ["MBBS", "MD/MS", "Nursing"],
  },
  {
    ...
    logo_image: "assets/images/colleges/gimsdurgapur/gims-logo.png",
    ...
    images: [
      "assets/images/colleges/gimsdurgapur/gims-campus.jpg",
      "assets/images/colleges/gimsdurgapur/gims-hospital.jpg",
      "assets/images/colleges/gimsdurgapur/gims-icu.jpg",
      "assets/images/colleges/gimsdurgapur/gims-library.jpg",
    ],
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/smcbolpur/smc-logo.png",
    ...
    images: [
      "assets/images/colleges/smcbolpur/smc-campus.jpg",
      "assets/images/colleges/smcbolpur/smc-auditorium.jpg",
      "assets/images/colleges/smcbolpur/smc-library.jpg",
      "assets/images/colleges/smcbolpur/smc-hostel.jpg",
    ],
    courses: ["MBBS"],
  },
  {
    ...
    logo_image: "assets/images/colleges/iimsr/iimsr-logo.png",
    ...
    images: [
      "assets/images/colleges/iimsr/iimsr-campus.jpg",
      "assets/images/colleges/iimsr/iimsr-hospital.jpg",
      "assets/images/colleges/iimsr/iimsr-lab.jpg",
      "assets/images/colleges/iimsr/iimsr-library.jpg",
    ],
    courses: ["MBBS", "MD/MS"],
  },
  {
    ...
    logo_image: "assets/images/colleges/snu/4.jpeg",
    ...
    approved_by: ["UGC", "AICTE", "BCI"],
    affiliated_to: "Autonomous University",
    admission_process: [
    ...
    images: ["assets/images/colleges/snu/4.jpeg", "assets/images/colleges/snu/snu2.jpg"],
    courses: [
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/harvard/1.jpeg",
    ...
    approved_by: ["Various US accreditation bodies"],
    affiliated_to: "Ivy League",
    admission_process: [
    ...
    images: [
      "assets/images/colleges/harvard/1.jpeg",
      "assets/images/colleges/harvard/harvard2.jpg",
      "assets/images/colleges/harvard/harvard3.jpg",
    ],
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/stanford/2.jpeg",
    ...
    approved_by: ["WASC Senior College and University Commission"],
    affiliated_to: "N/A",
    admission_process: [
    ...
    images: [
      "assets/images/colleges/stanford/2.jpeg",
      "assets/images/colleges/stanford/stanford2.jpg",
      "assets/images/colleges/stanford/stanford3.jpg",
    ],
  ...
  },
  {
    ...
    logo_image: "assets/images/colleges/oxford/5.jpeg",
    ...
    approved_by: ["UK Government", "Privy Council"],
    affiliated_to: "Russell Group, G5",
    admission_process: [
    ...
    images: ["assets/images/colleges/oxford/5.jpeg", "assets/images/colleges/oxford/oxford2.jpg"],
    courses: ["Humanities", "Mathematics", "Medical Sciences", "Social Sciences"],
  },
  {
    id: "cambridge",
    name: "University of Cambridge",
    logo_image: "assets/images/colleges/cambridge/6.jpeg",
    ...
    images: [
      "assets/images/colleges/cambridge/6.jpeg",
      "assets/images/colleges/cambridge/cambridge2.jpg",
    ],
    courses: ["Natural Sciences", "Engineering", "Mathematics", "Medicine"],
  },
];

// --- Courses Data (from existing course-details.js) ---
const courses = [
  {
    id: "mbbs",
    name: "MBBS (Bachelor of Medicine, Bachelor of Surgery)",
    description:
      "The MBBS is an undergraduate degree program in the medical field. It is a rigorous course that prepares students to become qualified doctors, covering subjects like anatomy, pharmacology, pathology, and practical surgery.",
    image: "assets/images/courses/course-banner-mbbs.jpg",
    specializations: [],
  },
  {
    id: "btech",
    ...
    description:
      "The Bachelor of Technology is an undergraduate engineering degree awarded for programs focusing on practical, skill-oriented training. It covers various specializations like Computer Science, Mechanical, Civil, and Electrical Engineering.",
    image: "assets/images/courses/course-banner-btech.jpg",
    specializations: [
      "Computer Science",
  ...
  },
  {
    ...
    description:
      "The Master of Technology is a postgraduate degree in engineering that provides advanced knowledge and specialization in a chosen field. It is research-intensive and prepares students for senior roles in industry and academia.",
    image: "assets/images/courses/course-banner-mtech.jpg",
    specializations: [],
  },
  {
    id: "bds",
    ...
    description:
      "The Bachelor of Dental Surgery is an undergraduate dentistry course. The program provides students with the knowledge and skills necessary to diagnose, treat, and prevent dental and oral diseases.",
    image: "assets/images/courses/course-banner-bds.jpg",
    specializations: [],
  },
  {
    id: "gnm",
    ...
    description:
      "General Nursing and Midwifery is a diploma course that trains students to work as nurses. The curriculum focuses on providing care to individuals, families, and communities, covering all aspects of healthcare.",
    image: "assets/images/courses/course-banner-gnm.jpg",
    specializations: [],
  },
  {
    id: "mba",
    ...
    description:
      "The Master of Business Administration is a postgraduate degree focused on business management and leadership. It covers areas like marketing, finance, operations, and strategy to prepare graduates for managerial roles.",
    image: "assets/images/courses/course-banner-mba.jpg",
    specializations: [],
  },
];
...
async function seed() {
  ...
  for (const college of colleges) {
    const { error } = await supabase.from("colleges").upsert(college, {
      onConflict: "id",
    });
    if (error) {
      console.error(`Error seeding college ${college.id}:`, error.message);
    } else {
